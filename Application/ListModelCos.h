...
class ListModelCos : public QAbstractListModel {
private:
	CosCumparaturi& cos;
	bool visible;
...
public:
	...
	ListModelCos(CosCumparaturi& cos) : cos{ cos }, visible{ true }, last_selected_item{ -1 } {

	}

	ListModelCos(ListModelCos& ot) = delete;

	ListModelCos& operator=(ListModelCos& ot) = delete;

	int rowCount(const QModelIndex& parent = QModelIndex()) const override {
		return (visible) ? (cos.nrProduseCos() + 1) : (0);
	}
